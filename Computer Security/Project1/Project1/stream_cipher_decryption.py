...
frequencies = []
keyNumbers = []
encodedText = "C:\\Users\\tyler.DESKTOP-7I7VF8T\\Desktop\\OneDrive\\17-18_Spring\\Computer Security\\Project1\\Project1\\challenge2.txt"
...
keyNumbers = []
for key in "Peaches":
    keyNumbers.append(ord(key))

#Diddledidodah : Text 1
#Peaches : Text 2
